...
namespace Bangazon.Controllers
{
    public class OrderProductsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.Product, "ProductId", "ApplicationUserId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderProductId,OrderId,ProductId")] OrderProduct orderProduct)
        {
            ...
            ViewData["OrderId"] = new SelectList(_context.Order, "OrderId", "ApplicationUserId", orderProduct.OrderId);
            ViewData["ProductId"] = new SelectList(_context.Product, "ProductId", "ApplicationUserId", orderProduct.ProductId);
            return View(orderProduct);
        }
